...
public class DestroySequentialTargets {
    /*
        ...
        to destroy all targets with values that can be represented as nums[i] + c * space, where c is any non-negative integer.
    ...
    public static void main(String[] args) {
        System.out.println("Solution: " + Solution.destroyTargets(new int[]{1,3,5,2,4,6}, 2));
    }
