...
public class EscapeALargeMaze {
    ...
    public static void main(String[] args) {
        System.out.println("Solution: " + Solution.isEscapePossible(new int[][]{{0,1}, {1,0}}, new int[]{0,0}, new int[]{0,2}));
    }
    ...
    static class Solution {
        ...
        public static boolean bfs(int[] source, int[] target, Set<String> blocks){
