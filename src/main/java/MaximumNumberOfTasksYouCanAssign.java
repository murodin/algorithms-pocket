...
public class MaximumNumberOfTasksYouCanAssign {
    ...
    public static void main(String[] args) {
        System.out.println("Solution: " + Solution.maxTaskAssign(new int[] {10,15,30}, new int[] {0,10,10,10,10}, 3, 10));
    }
    ...
    static class Solution {
        ...
        public static boolean canAssign(int count, int[] tasks, int[] workers, int pills, int strength){
