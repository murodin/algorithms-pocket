...
public class SoupServings {
    /*
        ...
        we will choose from the four operations with an equal probability 0.25. If the remaining volume of soup is not enough to complete the operation,
    ...
    public static void main(String[] args) {
        System.out.println("Solution: " + Solution.soupServings(100));
    }

    // Time: O(N)
    // Space: O(N)
    static class Solution {
        private static Map<Pair, Double> mp = new HashMap<>();
        private static double recur(int a, int b) {
