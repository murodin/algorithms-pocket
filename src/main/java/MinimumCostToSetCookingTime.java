public class MinimumCostToSetCookingTime {
    /*
        ...
        The microwave normalizes what you push as four digits by prepending zeroes. It interprets the first two digits as the minutes and
    ...
    public static void main(String[] args) {
        System.out.println("Solution: " + Solution.minCostSetTime(0, 1, 2, 76));
    }
    ...
    static class Solution {
        ...
        private static int cost(int mins, int secs, int startAt, int moveCost, int pushCost) {
