...
public class MinimumTimeToCompleteAllTasks {
    /*
        ...
        indicates that the ith task should run for a total of durationi seconds (not necessarily continuous) within the inclusive time range [starti, endi].
    ...
    public static void main(String[] args) {
        System.out.println("Solution: " + Solution.findMinimumTime(new int[][]{{1,3,2},{2,5,3},{5,6,2}}));
    }
