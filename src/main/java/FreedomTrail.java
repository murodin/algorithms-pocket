public class FreedomTrail {
    /*
        ...
        Initially, the first character of the ring is aligned at the "12:00" direction. You should spell all the characters in key one by one
        by rotating ring clockwise or anticlockwise to make each character of the string key aligned at the "12:00" direction and then by pressing the center button.
    ...
    public static void main(String[] args) {
        System.out.println("Solution: " + Solution.findRotateSteps("godding", "gd"));
    }
