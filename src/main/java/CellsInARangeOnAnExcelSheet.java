...
public class CellsInARangeOnAnExcelSheet {
    /*
        ...
        You are given a string s in the format "<col1><row1>:<col2><row2>", where <col1> represents the column c1, <row1> represents
        the row r1, <col2> represents the column c2, and <row2> represents the row r2, such that r1 <= r2 and c1 <= c2.
    ...
    public static void main(String[] args) {
        System.out.println("Solution: " + Solution.cellsInRange("A1:F1"));
    }
