public class LongestAbsoluteFilePath {
    /*
        ...
        which is the order of directories that must be opened to reach the file/directory itself, all concatenated by '/'s. Using the above example,
        the absolute path to file2.ext is "dir/subdir2/subsubdir2/file2.ext". Each directory name consists of letters, digits, and/or spaces.
    ...
    public static void main(String[] args) {
        System.out.println("Solution: "+ Solution.lengthLongestPath("dir\n\tsubdir1\n\t\tfile1.ext\n\t\tsubsubdir1\n\tsubdir2\n\t\tsubsubdir2\n\t\t\tfile2.ext"));
    }
    ...
    static class Solution {
        public static int lengthLongestPath(String input) {
            ...
            for (String s : ar) {
                ...
                count[tabIndex + 1] = s.substring(tabIndex + 1).length();
