...
public class BaseballGame {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Solution I: " + Solution_I.calPoints(ops));
        System.out.println("Solution II: " + Solution_II.calPoints(ops));
        System.out.println("Solution III: " + Solution_III.calPoints(ops));
    }
