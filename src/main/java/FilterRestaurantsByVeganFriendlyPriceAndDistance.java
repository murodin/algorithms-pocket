...
public class FilterRestaurantsByVeganFriendlyPriceAndDistance {
    /*
        ...
        or false (meaning you can include any restaurant). In addition, you have the filters maxPrice and maxDistance
        which are the maximum value for price and distance of restaurants you should consider respectively.

        Return the array of restaurant IDs after filtering, ordered by rating from highest to lowest. For restaurants with the same rating,
        order them by id from highest to lowest. For simplicity veganFriendlyi and veganFriendly take value 1 when it is true, and 0 when it is false.
    ...
    public static void main(String[] args) {
        System.out.println("Solution: " + Solution.filterRestaurants(
    ...
    static class Solution {
        private final static Comparator<int[]> comparator = (a, b) -> a[1] == b[1]? b[0] - a[0] : b[1] - a[1];
