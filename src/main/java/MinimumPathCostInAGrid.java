...
public class MinimumPathCostInAGrid {
    /*
        ...
        such that x < m - 1, you can move to any of the cells (x + 1, 0), (x + 1, 1), ..., (x + 1, n - 1). Note that it is not possible to move from cells in the last row.
    ...
    public static void main(String[] args) {
        System.out.println("Solution: " + Solution.minPathCost(
                new int[][]{{5,3},{4,0},{2,1}},
   ...
   static class Solution {
        private static int rec(int i, int j, int[][] grid, int[][] move, int[][] dp){
