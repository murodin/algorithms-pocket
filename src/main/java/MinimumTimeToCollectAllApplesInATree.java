...
public class MinimumTimeToCollectAllApplesInATree {
    /*
        ...
        exists an edge connecting the vertices ai and bi. Additionally, there is a boolean array hasApple, where hasApple[i] = true means that vertex i has an apple;
    ...
    public static void main(String[] args) {
        System.out.println("Solution: " + Solution.minTime(7,
    ...
    static class Solution {
        ...
        private static int dfs(int prev, int curr, ArrayList<Integer>[] a, List<Boolean> hasApple) {
            int ans=0;
            for(int x:a[curr]) {
                if(x!=prev){
