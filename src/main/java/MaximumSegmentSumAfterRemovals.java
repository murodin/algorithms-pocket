...
public class MaximumSegmentSumAfterRemovals {
    /*
        You are given two 0-indexed integer arrays nums and removeQueries, both of length n. For the ith query,
        the element in nums at the index removeQueries[i] is removed, splitting nums into different segments.
    ...
    public static void main(String[] args) {
        System.out.println("Solution: " + Arrays.toString(Solution.maximumSegmentSum(new int[]{3, 2, 11, 1}, new int[]{3, 2, 1, 0})));
    }
