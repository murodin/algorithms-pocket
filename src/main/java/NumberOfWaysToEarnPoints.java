public class NumberOfWaysToEarnPoints {
    /*
        There is a test that has n types of questions. You are given an integer target and a 0-indexed 2D integer array types
        where types[i] = [counti, marksi] indicates that there are counti questions of the ith type, and each one of them is worth marksi points.
    ...
    public static void main(String[] args) {
        System.out.println("Solution: " + Solution.waysToReachTarget(5, new int[][]{{50, 1}, {50, 2}, {50, 3}}));
    }
