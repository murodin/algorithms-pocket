public class DecodedStringAtIndex {
    ...
    public static void main(String[] args) {
        System.out.println("Test I -> Decoded String At Index: " + Solution.decodeAtIndex("leet2code3", 10));
        System.out.println("Test II -> Decoded String At Index: " + Solution.decodeAtIndex("ha22", 5));
    }
